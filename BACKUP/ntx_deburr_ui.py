...
class MainWindow(QMainWindow):
    ...
    def _create_page_path_geometry(self):
        ...
        grid.addWidget(QLabel("Input Path:"), row, 0)
        grid.addWidget(self.csv_path_edit, row, 1, 1, 2)
        row += 1

        grid.addWidget(browse_btn, row, 1)
        grid.addWidget(reload_btn, row, 2)
        row += 1
    ...
    def _create_page_nc_output(self):
        ...
        preview_btn = QPushButton("Preview NC (after generate)")
        preview_btn.clicked.connect(self._preview_nc_notice)
        grid.addWidget(preview_btn, row, 1, 1, 2)
    ...
    def _build_preview_nc_text(self):
        ...
        # Original path = raw model points
